    ...
    return (
        <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-slate-950 text-slate-100">
            <div className="flex min-h-screen w-full min-w-0">
                {/* SIDEBAR */}
                <aside className="hidden w-72 shrink-0 flex-col border-r border-slate-800 bg-slate-900/95 px-6 py-8 sm:flex">
                    <div className="mb-10 flex min-w-0 items-center gap-3">
                        <div className="min-w-0">
                            <p className="truncate text-sm font-semibold uppercase tracking-[0.24em] text-violet-200/80">
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                    {/* HEADER */}
                    <header className="min-w-0 border-b border-slate-800 bg-slate-950/95 backdrop-blur-xl">
                        <div className="mx-auto flex w-full min-w-0 max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 md:flex-row md:items-center md:justify-between">
                            {/* Header title */}
